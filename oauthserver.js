var oauth2orize = require('oauth2orize'),
		...
		AuthorizationCode = require("./models/user.js").AuthorizationCode,
...
server.deserializeClient(function(id, done) {
  User.findOne({_id: id, client: true}, function(err, client) {
...
server.exchange(oauth2orize.exchange.code(function(client, code, redirectURI, done) {
  AuthorizationCode.findOne({code: code, client: client._id}, function(err, authCode) {
    if (err) { return done(err); }
    if (client._id !== authCode.client) { return done(null, false); }
